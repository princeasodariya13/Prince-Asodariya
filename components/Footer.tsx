  ...
  return (
    <footer className="border-t border-border-subtle py-14">
      <div className="w-full max-w-[1180px] mx-auto px-[clamp(1.25rem,5vw,5rem)] flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
        ...
        <nav aria-label="Footer Navigation" className="flex flex-col gap-2 font-mono text-[0.8rem]">
          <span className="font-bold text-text-primary uppercase tracking-wider mb-1 text-[0.7rem]">Pages</span>
          <Link href="/" className="text-text-secondary hover:text-accent transition-colors">Home</Link>
          <Link href="/#projects" className="text-text-secondary hover:text-accent transition-colors">Project Case Studies</Link>
          <Link href="/journey" className="text-text-secondary hover:text-accent transition-colors">Development Journey</Link>
          <Link href="/contact" className="text-text-secondary hover:text-accent transition-colors">Contact Me</Link>
        </nav>
      </div>
